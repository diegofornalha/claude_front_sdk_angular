      ...
      <div class="input-container">
        ...
        <div class="input-box">
          <textarea
            ...
            [placeholder]="chat.messages().length === 0 ? 'Como posso ajudar você hoje?' : 'Enviar mensagem...'"
            rows="1"
          ...
          <div class="input-toolbar">
            <div class="toolbar-left">
              ...
              <div class="dropdown-container">
                <button class="toolbar-btn add-btn" (click)="toggleAddMenu()" [class.active]="isAddMenuOpen()">
                ...
                @if (isAddMenuOpen()) {
                  <div class="dropdown-menu">
                    ...
                    <button class="menu-item" [class.selected]="webSearchEnabled()" (click)="toggleWebSearch()">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                      ...
                      @if (webSearchEnabled()) {
                        <svg class="check" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#2563eb" stroke-width="3">
